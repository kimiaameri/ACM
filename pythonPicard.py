    ...
    with open(inputFile) as csv_file:
        ...
        for row in csv_reader:
            if count !=0:
                 ...
                 outFile.write(f'{minicondaBin}picard MarkDuplicates I=$WORK/ACM-outputs/sortsam/{row[0]}.sorted.bam O=$WORK/ACM-outputs/picard/{row[0]}.picard.bam M=$WORK/ACM-outputs/picard/picardlog/{row[0]}.picard.log\n')
